...
namespace PerfectAPI.Clients.ClientRepositories
{
    ...
    public class GetEmployeeDetails : BaseClient<EmployeeDetailsRequestModel,EmployeeDetails>, IGetEmployeeDetails
    {

        public GetEmployeeDetails(HttpClient httpClient, IEnvironmentSettings environmentSettings, IHttpClientFactory httpClientFactory, ILogger<GetEmployeeDetails> logger, IMapper mapper)//, IAsyncPolicy policy)
