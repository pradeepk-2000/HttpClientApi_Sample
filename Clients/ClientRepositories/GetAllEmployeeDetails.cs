...
namespace PerfectAPI.Clients.ClientRepositories
{
    ...
    public class GetAllEmployeeDetails : BaseClient<List<EmployeeDetails>>, IGetAllEmployeeDetails
    {

        public GetAllEmployeeDetails(HttpClient httpClient, IEnvironmentSettings environmentSettings, IHttpClientFactory httpClientFactory, ILogger<GetAllEmployeeDetails> logger, IMapper mapper)//, IAsyncPolicy policy)
